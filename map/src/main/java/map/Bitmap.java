...
public class Bitmap {
    ...
    private int[][] aiMap;
    private final Color[] arrayOfColors = {Color.GREEN, Color.WHITE, Color.RED, Color.GRAY, Color.BLUE, Color.MAGENTA, Color.PINK, Color.YELLOW, Color.CYAN};
    private final TileType[] arrayOfTileTypes = {TileType.GRASS, TileType.EARTH, TileType.OBSTACLE, TileType.ROAD, TileType.ROADLINEUP, TileType.ROADLINESIDE, TileType.STLEFT, TileType.STRIGHT, TileType.BLANK};

    public Bitmap() {
        URL url = Bitmap.class.getResource("/bitmaps/bitMap.png");
        try {
